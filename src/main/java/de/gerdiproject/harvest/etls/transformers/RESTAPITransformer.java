...
/**
 * This transformer parses metadata from a {@linkplain RESTAPIVO}
 * and creates {@linkplain DataCiteJson} objects from it.
 *
 * @author Manuel Scholz
 */
public class RESTAPITransformer extends AbstractIteratorTransformer<RESTAPIVO, DataCiteJson>
{
    @Override
    ...
    @Override
    protected DataCiteJson transformElement(RESTAPIVO source)
    {
        // create the document
